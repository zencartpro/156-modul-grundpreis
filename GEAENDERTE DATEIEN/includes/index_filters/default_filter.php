 ...
 * @version $Id: default_filter.php for Grundpreis 2019-07-21 08:41:16Z webchills $
 */
if (!defined('IS_ADMIN_FLAG')) {
  die('Illegal Access');
}
// added for more products details (e.g. products_base_unit_price and products_base_unit) 2006-05-26 UBW-cart #joco
// ask for new or extra products details
    $extra_products_details = '';
    if (file_exists (DIR_WS_INCLUDES . 'index_filters/' . 'extra_products_filter.php')) {
      require (DIR_WS_INCLUDES . 'index_filters/' . 'extra_products_filter.php');
      $select_column_list .= $extra_products_details;
    }
// end added #joco
