 ...
 * @version $Id: tpl_product_info_display.php for Grundpreis 2020-07-24 16:35:36Z webchills $
 */
...
?></h2>
<!--bof base unit price  -->
<?php if (SHOW_BASE_UNIT_PRICE == 1 or SHOW_BASE_UNIT_PRICE == 2) { ?>
<div id="baseunitprice">
<?php

  if (zen_not_null($product_info->fields['products_base_unit_price']) && $product_info->fields['products_base_unit_price'] <>0) {
