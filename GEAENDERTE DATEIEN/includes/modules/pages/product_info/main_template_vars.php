 ...
 * @version $Id: main_template_vars.php for Grundpreis 2019-07-21 08:47:36Z webchills $
 */
/*
...
// add for base_unit_price 2006.06.10 CCS-cart #joco 
    $products_base_unit_price = $currencies->display_price($product_info->fields['products_base_unit_price'],
                                zen_get_tax_rate($product_info->fields['products_tax_class_id'])).'/'.$product_info->fields['products_base_unit'];
// end add base price
...
// add for base unit price 2006-06-12 CCS-cart #joco
  $flag_show_product_info_base_unit = zen_get_show_product_switch($_GET['products_id'], 'products_base_unit_price');
// end add 
