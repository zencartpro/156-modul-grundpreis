 ...
 * @version $Id: header_php.php for Grundpreis 2019-07-21 08:24:50Z webchills $
 */
...
$select_str = "SELECT DISTINCT " . $select_column_list .
              " p.products_sort_order, m.manufacturers_id, p.products_id, pd.products_name, p.products_price, p.products_base_unit_price, p.products_base_unit, p.products_tax_class_id, p.products_price_sorter, p.products_qty_box_status, p.master_categories_id, p.product_is_call ";
