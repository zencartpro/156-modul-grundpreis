 ...
 * @version $Id: copy_product_confirm.php for Grundpreis 2019-07-21 08:49:16Z webchills $
 */
...
// Copy attributes to duplicate product
  ...
  if ($_POST['copy_as'] == 'link') {
    ...
    $product = $db->Execute("SELECT products_type, products_quantity, products_model, products_image,
                                    ...
                                    products_tax_class_id, manufacturers_id, products_base_unit_price, products_base_unit,
    ...
    $db->Execute("INSERT INTO " . TABLE_PRODUCTS . " (products_type, products_quantity, products_model, products_image,
                                                      ...
                                                      manufacturers_id, products_base_unit_price, products_base_unit, products_quantity_order_min, products_quantity_order_units,
			  ...
			  '" . zen_db_input($product->fields['products_base_unit_price']) . "',
			  '" . zen_db_input($product->fields['products_base_unit']) . "',
