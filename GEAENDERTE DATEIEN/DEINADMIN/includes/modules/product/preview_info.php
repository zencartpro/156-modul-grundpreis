 ...
 * @version $Id: preview_info.php for Grundpreis 2019-07-21 08:49:16Z webchills $
 */
...
<div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-sm-6 text-right">
          ...
          <?php echo ($pInfo->products_base_unit_price > 0 ? '<span class="main">' . '<br />' . TEXT_PRODUCTS_BASE_UNIT_PRICE . ' ' . $currencies->format(zen_round($pInfo->products_base_unit_price,3)) . '/' . $pInfo->products_base_unit . '</span>' : ''); ?>
