 ...
 * @version $Id: collect_info.php for Grundpreis 2020-10-10 13:09:50Z webchills $
 */
...
// hidden fields not changeable on products page
  ...
  <div class="well" style="color: #31708f;background-color: #d9edf7;border-color: #bce8f1;;padding: 10px 10px 0 0;">
    ...
    <div class="form-group">
      <?php echo zen_draw_label(TEXT_PRODUCTS_BASE_UNIT_PRICE, 'products_base_unit_price', 'class="col-sm-3 control-label"'); ?>
    <div class="col-sm-9 col-md-6">
        <?php echo zen_draw_input_field('products_base_unit_price', $pInfo->products_base_unit_price, 'class="form-control"'); ?>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9 col-md-6">    	
        <?php echo zen_draw_input_field('products_base_unit', $pInfo->products_base_unit, 'class="form-control"'); ?>
    </div>
  </div>
